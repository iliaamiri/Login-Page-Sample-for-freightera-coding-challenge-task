<div class="content">
    <div class="row" id="chartBig1_Box" style="display: none">
        <div class="col-12">
            <div class="card card-chart">
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h5 class="card-category">Total Transactions Amounts</h5>
                            <h2 class="card-title"><i class="tim-icons icon-delivery-fast text-info"></i> Economic Performance (In Tomans)</h2>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                                <label class="btn btn-sm btn-primary btn-simple active" id="0">
                                    <input type="radio" name="options" checked>
                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">This Week</span>
    ...
    <div class="row" id="chartBig2_Box" style="display: none">
        <div class="col-12">
            <div class="card card-chart">
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            ...
                            <h2 class="card-title">Serving Performance</h2>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                                <label class="btn btn-sm btn-primary btn-simple active" id="20">
                                    <input type="radio" name="options" checked>
                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">This Week</span>
                                    <span class="d-block d-sm-none">
                          <i class="tim-icons icon-single-02"></i>
                                ...
                                <label class="btn btn-sm btn-primary btn-simple" id="21">
                                    <input type="radio" class="d-none d-sm-none" name="options">
                                    <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Monthly</span>
                                    <span class="d-block d-sm-none">
                          <i class="tim-icons icon-gift-2"></i>
